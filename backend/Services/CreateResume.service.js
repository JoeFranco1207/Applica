  ...
  <html>
    <head>
      <style>
        ...
        h2 { border-bottom: 2px solid #e5e7eb; padding-bottom: 5px; margin-top: 30px; color: #374151; }
        p { margin: 5px 0; line-height: 1.5; }
        .section { margin-bottom: 20px; }
        .skills { list-style: none; padding: 0; display: flex; flex-wrap: wrap; gap: 10px; }
        .skills li { background: #f3f4f6; padding: 6px 12px; border-radius: 6px; font-size: 14px; }
      </style>
    </head>
